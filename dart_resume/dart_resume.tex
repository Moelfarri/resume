...
\textbf{Produksjonsfasen} & Jan.2026 - Jun.2026 \\
\end{tabularx}
...
\noindent
\begin{tabularx}{\linewidth}{@{}X r@{}}
\textbf{Produksjonsfasen} & Jan.2025 -- Des.2025 \\
\end{tabularx}
...
\noindent
\begin{tabularx}{\linewidth}{@{}X r@{}}
\textbf{Modningsfasen} & Jan.2024 - Des.2024 \\
\end{tabularx}
...
\noindent
\begin{tabularx}{\linewidth}{@{}X r@{}}
\textbf{Restruktureringsfasen} & Jan.2023 - Des.2023 \\
\end{tabularx}
...
\noindent
\begin{tabularx}{\linewidth}{@{}X r@{}}
\textbf{Startupfasen} & Aug.2022 - Des.2022 \\
\end{tabularx}
...
\noindent
\begin{tabularx}{\linewidth}{@{}X r@{}}
\textbf{Maritime Cybernetics Advisory} & 2021 -- 2022 \\
\end{tabularx}
...
\noindent
\textbf{Prosjekt:} Elias har utviklet nye funksjoner i DP-CAP og DYN-CAP applikasjonene, brukt til beregninger og sertifisering av dynamisk posisjonering av skip. Han utviklet i Python/OpenCV basert på Watershed-metoden, som reduserte manuelt arbeid fra flere dager til sekunder, og som ble kritisk for sertifiseringsanalyser bestilt av kunder som Equinor. Dette økte lønnsomheten av disse rapportene massivt, med en fastpris på 100 000 NOK så tok det et par klikk å levere samme analyse som kunne ta opp til en uke før.
