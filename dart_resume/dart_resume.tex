...
& Elias etablerte en vertical slices og  micro-frontends arkitektur for å gjøre det enkelst mulig for nye utviklere å komme i gang og bidra i den etterhvert voksende native infrastrukturen. Dette gjorde at utviklere på teamet kunne jobbe på spesifikke features isolert fra alle andre kontekster, og dermed øke produktiviteten. Han sikret arkitekturens robusthet gjennom 400+ custom lint-regler, codegen-verktøy og dokumentasjon. Dette sikret at teamet kunne komfortabelt skrive kode de var trygge på, enten med Flutter/Dart, rent Native med Kotlin/Swift og teamet var blitt et Native Platforms team. \\
& \\
& I tillegg så fikk Elias på plass en del agentisk AI infrastruktur (relevant MCP-kontekst, MD-dokumentasjon, subagenter, etc) som gjorde det enkelt å tilrettelegge for utviklerne å bruke verktøyet de likte best (Claude Code, GitHub Copilot, Gemini m.fl.).  \\
& \\
...
& \\
& \textbf{Kompetanser:} Flutter, Dart, Kotlin, Swift, SwiftUI, iOS, Android, BLE (CoreBluetooth, Android Bluetooth API), ESP32, AVFoundation, CameraX, IoT-integrasjon, mobil monorepo-arkitektur, vertical slices, micro-frontends, in-house design system, 400+ custom lint-regler, codegen-verktøy, CI/CD (Azure DevOps, Fastlane, Maestro), self-hosted Mac Mini agent, TestFlight, Google Play Console, Firebase Crashlytics, Firebase Analytics, Privacy Manifest, GDPR compliance, stakeholder management, teamledelse, onboarding, rekruttering (20+ intervjuer), delivery management, produktstrategi, continuous discovery \& delivery, trio-modellen, agentisk AI-tilrettelegging (Claude Code, Gemini, Copilot). \\
\end{longtable}
