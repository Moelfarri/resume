...
% --- Header with photo on the left and title on the right ---
\vspace*{1em}
...
\begin{minipage}[c]{0.25\textwidth}
    \centering
    \begin{tikzpicture}
        \clip (0,1.5) circle (2cm); % adjust radius if needed
        \node at (0,0) {\includegraphics[width=5cm]{../portrait.jpg}};
    \end{tikzpicture}
\end{minipage}%
\hfill
\begin{minipage}[c]{0.7\textwidth}
    {\Huge \textbf{\ubuntu{Elias Elfarri}}}\\[0.5em]
    {\large \ubuntu{Mobilutvikler / Tech Lead}}\\[0.75em]
    \normalsize
    \href{mailto:moelfarri@gmail.com}{moelfarri@gmail.com} \textbullet\ 
    45 18 27 12 \textbullet\ 
    Oslo
\end{minipage}
...
\vspace{1.5em}
\noindent
% ========= SHORT PROFILE (like the example intro paragraph) =========
Sivilingeniør i kybernetikk og robotikk som de siste årene har jobbet som  tech lead, mobilutvikler og fagansvarlig. 
Jeg har erfaring fra både native-utvikling i \textbf{Swift} og \textbf{Kotlin} og kryssplattform med \textbf{Flutter/Dart}, 
og har vært med på å bygge opp mobilteam, etablere monorepo-arkitektur og utvikle skalerbare kodebaser i produksjon.
Jeg har levert industrielle løsninger innen energi- og offshore-sektoren med \textbf{BLE-basert IoT}, kamera, sanntidsgrafer 
og integrasjon mot spesialisert hardware. Som faglig pådriver er jeg også arrangør og leder for \textbf{Flutter Oslo}-miljøet, 
og holder kurs, foredrag og fagkvelder som løfter både prosjekter og kolleger.

\vspace{1.75em}

% ========= NØKKELKOMPETANSE =========
\noindent
{\Large \textbf{\ubuntu{Nøkkelkompetanse}}}\\[0.25em]
\noindent\rule{\linewidth}{0.4pt}

\vspace{0.75em}

\begin{itemize}[leftmargin=*]
    \item \textbf{Tech lead}: Ansvar for teknisk retning, arkitektur, kodekvalitet, domenemodeller, design system, prosess og leveranser i mobilteam, samt onboarding, rekruttering og tett samarbeid med produkt og design.
    \item \textbf{Mobilutvikling}: Fire års erfaring fra produksjonsprosjekter på iOS og Android med Swift, Kotlin og Flutter/Dart, inkludert publisering av flere apper til App Store og Google Play.
    \item \textbf{Industriell IoT og BLE}: Erfaring med Bluetooth Low Energy, ESP32, egen GATT-protokoll, hardware-integrasjon og bruk av mobil som erstatning for kostbare industrielle enheter.
    \item \textbf{Arkitektur og kvalitet}: Monorepo-arkitektur for mobil med flere apper, pakker og first-party plugins, in-house designsystem, codegen-verktøy og omfattende linting, tester og CI/CD.
    \item \textbf{Faglig engasjement og formidling}: Leder Flutter Oslo med 500+ medlemmer, konferanse- og meetup-arrangør, foredragsholder og skribent om Flutter/Dart og moderne mobilutvikling.
\end{itemize}

\vspace{1.75em}

% ========= KOMPETANSE (table like in the example) =========
\noindent
{\Large \textbf{\ubuntu{Kompetanse}}}\\[0.25em]
\noindent\rule{\linewidth}{0.4pt}
...
\textbf{Programmeringsspråk} & 
Dart, Swift, Kotlin, Objective-C, Java, C, C\#, TypeScript, JavaScript, Python \\

\textbf{Kunstig Intellegens} & 
Claude Code, Gemini CLI, ChatGPT, Codex, Github Copilot, MCP server API-er \\

\textbf{Rammeverk} & 
Flutter, SwiftUI, UIKit, Jetpack Compose, Android SDK, RxDart, BLoC, Riverpod, 
gRPC, WebSockets \\

\textbf{Mobil \& IoT} &
iOS, Android, Bluetooth Low Energy (CoreBluetooth, Android Bluetooth), ESP32, 
kamera (AVFoundation, CameraX), Live Activities, Widgets, offline-synk (Drift/SQLite) \\

\textbf{Verktøy \& DevOps} & 
Xcode, Android Studio, VS Code, Azure DevOps, Git, CI/CD (Fastlane, xcodebuild, 
TestFlight, Google Play Console), Maestro, Melos, Mason, Widgetbook, Shorebird \\

\textbf{Sky \& analyse} &
Firebase Crashlytics, Firebase Analytics, Firebase Performance, Google Cloud Console, 
monitorering, logging og personvern (GDPR, Privacy Manifest, Privacy Policy) \\

\textbf{Domener} &
Energi- og offshore-sektor, industriell testing og verifikasjon, digitale tvillinger, 
sanntidsdata fra sensorer og prosessanlegg \\

\textbf{Språk} & 
Norsk (morsmål), engelsk (flytende), fransk (middels), arabisk/Darija (morsmål), berber (morsmål)\\
\end{tabularx}

\vfill

% (Optional) a tiny footer line on page 1, similar to many consultant-CV-templates
%\noindent\rule{\linewidth}{0.4pt}
%\small{Oppdatert: \today}

\newpage
% --- Resten av CV-en din (erfaring, prosjekter, utdanning osv.) kan fortsette her ---
...
\noindent
\begin{tabularx}{\linewidth}{@{}lX@{}}
Jan.2026 - Jun.2026 & InlineX AS, Kommersialiseringsfasen \\
Jan.2025 - Des.2025 & InlineX AS, Produksjonsfasen \\
...
{\large Kommersialiseringsfasen } & Jan.2026 - Jun.2026 \\
\end{tabularx}
...
\newline
\noindent
Kotlin, Azure Entra, Azure Pipelines, Azure Docker Container Registry, Firebase Crashlytics, Microsoft Clarity,
Firebase Analytics, Firebase Performance Monitoring, Firebase Remote Config.
...
\newline
\noindent
Implementerte InlineX Workflow Engine; en high impact low effort feature for tilpasning av arbeidsflyter
for nøkkelkunder. Det reduserte oppsettstid til <1 dag for å lage en "workflow" for en kunde,
og løsningen genererte over 1,2 MNOK i ekstra abonnementsinntekter per kunde i 2026. 

\vspace{0.5em}
\noindent
Ledet et team på fem utviklere gjennom leveranse av 30+ features i 2026, 
hvor jeg løftet app-stabiliteten fra 80\% til over 95\% crash-free sessions via proaktiv overvåking, 
god devops, smarte breadcrumbs og ressursallokering til diverse utfordringer. 
Vi nådde en jevn leveransefrekvens på hver andre uke, og en rask responstid på kritiske feil, 
blant annet via feature flags. Hadde i tillegg et godt samarbeid med design, domene ekspert, domene arkitekt og produktleder 
for å sikre at vi leverte gode ekspertsystemer for ventil teknikere i felt.
...
\noindent
\begin{tabularx}{\linewidth}{@{}X r@{}}
{\large Produksjonsfasen} & Jan.2025 - Des.2025 \\
\end{tabularx}
