...
\noindent
\begin{tabularx}{\linewidth}{@{}lX@{}}
Jan.2026 - Jun.2026 & InlineX AS, Inline X Stream Appen \\
...
{\large Inline X Stream Appen } & Jan.2026 - Jun.2026 \\
\end{tabularx}
...
\newline
\noindent
Tech Lead, mobilutvikler, fullstack utvikler 
...
\newline
\noindent
SwiftUI, Swift Charts, Combine, AVFoundation, CoreBluetooth
...
\vspace{0.5em}
\noindent
I 2026 jobbet jeg med overvåking av InlineX Stream appen i produksjon via Clarity, Firebase Analytics, Crashlytics. Mye code review, parprogrammering, ledet et team med 5 utviklere som produserte 30+ Features og driftet en mobil app. Vi hadde en KPI på 80\% crash-free brukersesjoner og nådde 92,3\% i snitt under min ledelse.
Jeg lagde en decision tree motor for å støtte tredje parts arbeidsflyter 
i appen siden Chevron, Equinor, Aker, SLB og flere har alle sine måter å jobbe på som vårt eksertsystem skulle støtte. Drevet med modelleringsarbeid sammen med domene ekspert, for å gjøre om domene specs til data modeller, i tillegg koordinert med designer for å sikre at design reflekterer modellene våre og 
hatt ansvar for å formulere, prioritere og delegere programmeringsarbeid til utviklerne.
